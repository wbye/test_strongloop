...
db.once('open', function() {
    ...
    Activity.find({}, function (err,activities) {
        var FRONT_Data = [{
            ...
            spics : [ "/image/activity201603/s_coleflower1.jpg",
                "/image/activity201603/s_coleflower2.jpg",
                "/image/activity201603/s_coleflower3.jpg",
                "/image/activity201603/s_coleflower4.jpg" ],
            title:"奉贤油菜花",
            tags:['自驾','油菜花'],
            time:"三月底~四月初",
            cost:"AA",
            ...
            spics : [
                "/image/activity201603/s_chongming01.jpg",
                "/image/activity201603/s_chongming02.jpg",
                "/image/activity201603/s_chongming04.jpg",
                "/image/activity201603/s_chongming05.jpg",
                "/image/activity201603/s_chongming03.jpg",
            ],
            ...
            spics : [
                "/image/activity201603/s_owlcity01.jpg",
                "/image/activity201603/s_owlcity02.jpg",
            ],
        ...
        if(activities.length===0){
            Activity.create(FRONT_Data, function (err,activity) {
                if(err){
                    console.log(err);
                }else{
