require([
    ...
    var CurrentActivities = Activities.extend({
        _pparse: function (res) {
            var FRONT_Data = [{
                name:"2016_fengxian",
            ...
            _.each(res, function (item,index) {
                FRONT_Data[index] = _.extend(FRONT_Data[index],{likes:item.likes,"_id":item._id});
            });
            console.log(FRONT_Data);
            return FRONT_Data;
        }
    })
    var activites = new CurrentActivities();
